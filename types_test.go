...
func TestNodeList_All(t *testing.T) {
	...
	t.Run("empty", func(t *testing.T) {
		t.Parallel()
		got := slices.Collect(NodeList(nil).All())
		assert.Empty(t, got)
	})

	t.Run("full_iteration", func(t *testing.T) {
		t.Parallel()
		nl := NodeList{1, "two", 3.0}
		got := slices.Collect(nl.All())
...
func TestLocatedNodeList_All(t *testing.T) {
	...
	t.Run("empty", func(t *testing.T) {
		t.Parallel()
		got := slices.Collect(LocatedNodeList(nil).All())
		assert.Empty(t, got)
	})
...
func TestLocatedNodeList_Values(t *testing.T) {
	...
	t.Run("empty", func(t *testing.T) {
		t.Parallel()
		got := slices.Collect(LocatedNodeList(nil).Values())
		assert.Empty(t, got)
	})
	...
	t.Run("full_iteration", func(t *testing.T) {
		t.Parallel()
		list := LocatedNodeList{
			{Value: "a", Path: mustNormalizedPath(IndexElement(0))},
			{Value: "b", Path: mustNormalizedPath(IndexElement(1))},
		}
		got := slices.Collect(list.Values())
		if diff := cmp.Diff([]any{"a", "b"}, got); diff != "" {
...
func TestLocatedNodeList_Paths(t *testing.T) {
	...
	t.Run("empty", func(t *testing.T) {
		t.Parallel()
		got := slices.Collect(LocatedNodeList(nil).Paths())
		assert.Empty(t, got)
	})
	...
	t.Run("full_iteration", func(t *testing.T) {
		t.Parallel()
		list := LocatedNodeList{
			{Value: 1, Path: mustNormalizedPath(NameElement("x"))},
			{Value: 2, Path: mustNormalizedPath(NameElement("y"))},
		}
